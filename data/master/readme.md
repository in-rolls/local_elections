...
1,051,560 seat-event records across 15 states, in one declared schema. One file per state; the headers are identical, so concatenating them is the whole table.
...
- **dataset** — 563,176 rows, traceable to the file it came from and no further

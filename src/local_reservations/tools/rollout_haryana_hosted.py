...
from local_reservations.tools.historical_harvest import checksum
from local_reservations.tools.parse_haryana_gazettes import candidate_category
from local_reservations.tools.source_nonseat_reviews import apply_source_nonseat_reviews
...
def apply_source_office_reviews(records):
    ...
    from local_reservations.tools.source_context_reviews import (
...
def export(frame):
    ...
    from local_reservations.tools.source_gp_fragment_context_reviews import (
        apply_source_gp_fragment_context_reviews,
    )
    from local_reservations.tools.source_identity_reviews import (
        apply_source_identity_reviews,
    )
    from local_reservations.tools.source_samiti_reviews import (
    ...
    from local_reservations.tools.source_district_reviews import (
